...
export function KFCMenuItem({
  ...
  return (
    <div className="group relative bg-card rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
      {/* Image Container */}
      <div className="relative aspect-square overflow-hidden bg-muted">
        ...
        <Button
          ...
          disabled={isAdding}
          className={cn(
            "absolute bottom-2 right-2 h-10 w-10 rounded-full shadow-lg transition-all duration-300",
            isAdding 
