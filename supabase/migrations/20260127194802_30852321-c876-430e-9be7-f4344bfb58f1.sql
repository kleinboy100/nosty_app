-- Fix security definer view warning by adding security_invoker
...
-- Add permissive SELECT policy on base restaurants table for the view to work
CREATE POLICY "Anyone can view active restaurants via view"
